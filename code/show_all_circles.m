function show_all_circles(I, cx, cy, rad, threshold, k, start_sigma,num_scales, color, ln_wid)
...
title(sprintf('%d circles, threshold = %.2f, k = %d, start sigma = %.2f, #Scales = %d', size(cx,1),threshold,k, start_sigma, num_scales));
